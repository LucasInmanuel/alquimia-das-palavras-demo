export default class Itens {
  ...
  dropItem(areaDrop) {
    ...
    if (areaDrop != null) {
      ...
      areaDrop.addEventListener("drop", () => {
        ...
        if (dragElement.id === "revelador-simples") { this.reveladorSimples() };
  ...
  reveladorSimples() {
    ...
    do {
      ...
      var indiceRandom = Math.floor(Math.random() * this.palavraOculta.length);
    ...
    var inputEscolha = document.getElementById("palavraEsqueci");
    inputEscolha.placeholder = "Qual é a palavra? " + oculta1 + revelar + oculta2;
